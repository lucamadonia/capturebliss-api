...
public interface Routes {
  ...
  String REFILL_CAPTUREBLISS_CREDIT = "/ide/refill_capturebliss_credit/{org_id}";
  String MIGRATE_CAPTUREBLISS_CREDIT = "/ide/migrate_capturebliss_credit/{org_id}";
  ...
  // INFO although this is named as cobalt event, this event is capturebliss's internal event and is used in multiple areas
