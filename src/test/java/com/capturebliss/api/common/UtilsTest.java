...
//                .customerEmail("akash@capturebliss.com")
//                .request(new Environment("capturebliss-test", "test_PVyQEHcqmvLv3FT3Nw6AY7P94qkL0FAw"));
//
...
//                .firstName("Test")
//                .lastName("User")
//                .email("testuser@captureblissacme.com")
//                .locale("fr-CA")
//                .request(new Environment("capturebliss-test", "test_PVyQEHcqmvLv3FT3Nw6AY7P94qkL0FAw"));
...
//                .firstName("Test2")
//                .lastName("User2")
//                .email("test2user2@captureblissacme.com")
//                .company("captureblissacme")
//                .request(new Environment("capturebliss-test", "test_PVyQEHcqmvLv3FT3Nw6AY7P94qkL0FAw"));
//            Customer customer = result.customer();
//            System.out.println(customer.toJson());
...
//        System.out.println(readableId);
  ...
  void appendSuffixAfterFilename() {
    String s1 = Utils.appendSuffixAfterFilename(
      "https://capturebliss-app-gamma.s3.ap-south-1.amazonaws.com/akashgoswami/job_test/test_img_3.png",
      "720"
    );
    Assertions.assertTrue(s1.endsWith("_720.png"));

    String s2 = Utils.appendSuffixAfterFilename(
      "https://capturebliss-app-gamma.s3.ap-south-1.amazonaws.com/akashgoswami/job_test/test_img_3",
      "720"
    );
